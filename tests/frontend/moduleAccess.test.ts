...
import { MODULE_DEFINITIONS, canAccessModule, visibleModules } from '../../src/lib/moduleAccess';
...
describe('module access', () => {
  ...
  it('allows free modules and basic monitoring while locking paid modules from server features', () => {
    ...
    expect(canAccessModule('digitalTwin', user, free)).toBe(false);
  });
